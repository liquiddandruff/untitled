...
_Debug.handleKey = function(a, b)
	if a == "`" then --f8
		--if love.keyboard.isDown("`") or love.keyboard.isDown("rshift") or love.keyboard.isDown("lctrl") or love.keyboard.isDown("rctrl") then --Support for both Shift and CTRL
